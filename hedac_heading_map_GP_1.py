...
===============================
"""
param_file = os.path.dirname(os.path.realpath(__file__)) + '/params/' + 'hedac_params_map_1.json'
...
coverage_density_hist = np.memmap('coverage_density_hist.dat', dtype='int32', mode='w+', shape=(10, 2, param.nbDataPoints, param.nbAgents))
coverage_density_prob_hist = np.memmap('coverage_density_prob_hist.dat', dtype='float32', mode='w+', shape=(10, param.nbDataPoints, param.nbAgents))
